...
if (isset($_POST['submit'])) {
	...
	if (!isset($error)) {
		...
		if ($flag == 'tcv') {
			...
			$data .= '<p><a style="background-color: yellow" href="html.php?link=' . $url . '&s=' . $start . '&e=' . $end . '&slug=' . $link . '">
				html.php?link=' . $url . '&s=' . $start . '&e=' . $end . '
			</a></p>';
			...
			$data .= '<p><a style="background-color: yellow; display: block; padding: 10px;" href="'.$HOME.'/TTV/html.php?name='.$link.'&s='.$start.'&e='.$end.'">
				html.php?name='.$link.'&s='.$start.'&e='.$end.'
			</a></p>';
			$data .= '<div style="white-space: nowrap;overflow: auto;">';
			...
			$data .= '<p><a style="background-color: yellow; display: block; padding: 10px;" href="'.$HOME.'/TF/html.php?name='.$link.'&s='.$start.'&e='.$end.'">
				html.php?name='.$link.'&s='.$start.'&e='.$end.'
			</a></p>';
			$data .= '<div style="white-space: nowrap;overflow: auto;">';
			for ($i=$start-1; $i <= $end-1; $i++) { 
