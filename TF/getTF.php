...
preg_match('#<div id="chapter-c" class="chapter-c">(.*?)</div><div class="hidden-xs#is', $single_curl, $content);
...
$noidung = preg_replace('/\s*Chương\s*\d+\s?:[^<\n]/iu', '', $noidung);
// nl2p
if ($site['nl2p'] == 'yes') {
...
echo "$tieude<br>➥<br>➥<br><br>$noidung<br>➥<br>➥<br>➥";
